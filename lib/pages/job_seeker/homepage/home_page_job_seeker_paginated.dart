...
import 'package:pabjobs/entities/job_details_model_pagination.dart';
import 'package:shimmer/shimmer.dart';

import 'package:pabjobs/pages/job_seeker/applied_jobs/applied_jobs.dart';
import '../../../common/homepage_card1.dart';
import '../../../common/homepage_card2.dart';
import '../../../theme/color_theme.dart';
import '../../../theme/text_theme.dart';
import '../filter/filter_listing.dart';
import '../filter/filter_page.dart';
import '../filter/search_page.dart';
import '../profile/edit_profile/edit_profile_details.dart';
import '../profile/my_resume/my_resume.dart';
import 'favourites/favourites.dart';
import 'homepage_controller.dart';
import 'job_alert/job_alert.dart';

import 'job_details.dart/job_details.dart';

class HomePageJobSeekerPaginated extends StatefulWidget {
  const HomePageJobSeekerPaginated({Key? key}) : super(key: key);

  @override
  State<HomePageJobSeekerPaginated> createState() =>
      _HomePageJobSeekerPaginatedState();
}

class _HomePageJobSeekerPaginatedState
    extends State<HomePageJobSeekerPaginated> {
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverAppBar(
                    ...
                    if (controller.isLoading.value) {
                      ...
                      return InkWell(
                        ...
                        child: Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(40),
                              child: (controller.data2.value.profileImage ==
                                      null)
                        ...
                        if (controller.isLoading.value) {
                          return Shimmer.fromColors(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:
                                        const Color(0xffF5F5F5).withOpacity(.3),
                    ...
                    child: Stack(
                      children: [
                        Container(
                          ...
                          child:
                              Image.asset("assets/logos/notification_icon.png"),
                        ),
                        Positioned(
                            right: 1,
                            top: 2,
            ...
            ///Rounded top of the white body is build here
          ...
          ///banner, locations, recommended jobs
          SliverToBoxAdapter(
            child: Container(
                decoration: const BoxDecoration(
                    color: Color(0xffF5F5F5),
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        width: Get.width,
                        child:
                            Image.asset("assets/images/homepage_banner1.png"),
                      ),
                    ),
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemCount:
                                              controller.data.value.data.length,
                                          itemBuilder: (context, index) {
                                            return HomePageCard1(
                                              name: controller.data.value
                                                  .data[index].jobId!.title!,
                                              description: (controller
                                                  ...
                                                  : controller
                                                      ...
                                                      .recruiter!
                                                      .companyname!,
                                              jobtype: controller.data.value
                                                  .data[index].jobId!.jobType!,
                                              place: controller
                                                  .data
                                                  .value
                                                  .data[index]
                                                  .jobId!
                                                  .cities![0],
                                              salary: controller.data.value
                                                  .data[index].jobId!.salary
                                                  .toString(),
                                              image: (controller
                                                          .data
                                                          .value
            ...
            if (controller.isJobLoading.value) {
              ...
              return SliverToBoxAdapter(
                child: ConstrainedBox(
                  constraints: const BoxConstraints(minHeight: 100 * 5),
                  child: ListView.builder(
              ...
              if (controller.posts.isEmpty) {
                if (controller.loading.value) {
                  ...
                  return SliverToBoxAdapter(
                      child: Center(child: errorDialog(size: 20)));
                }
              }
              return SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    ...
                    return HomePageCard2(
                      name: post.title!,
                      description: (post.recruiter == null)
                          ? "Unknown"
                          : post.recruiter!.companyname.toString(),
                      jobtype: (() {
                      ...
                      callback: () {
                        Get.to(() => const JobDetails(), arguments: post.id);
                      },
                      image: (post.recruiter == null)
                          ? Image.asset("assets/logos/company_logo.png")
                          : (post.recruiter!.profileImage == null)
                              ? Image.asset("assets/logos/company_logo.png")
                              : Image.network(
                                  post.recruiter!.profileImage.toString()),
                      favourite: (post.wishlist != false)
                          ? IconButton(
                              onPressed: () {
                                controller.addtofavourites(
                                    post.id.toString(), "remove", index);
                              },
                              icon: ImageIcon(
                                Image.asset(
