...
import 'package:pabjobs/common/custom_searchable_dropdown.dart';
import 'package:pabjobs/entities/api_service.dart';
import 'package:pabjobs/pages/job_seeker/profile/my_resume/education/education_controller.dart';
import 'package:pabjobs/pages/job_seeker/profile/my_resume/employment/edit_employement_details/edit_employement_details_controller.dart';
import 'package:pabjobs/theme/color_theme.dart';
import 'package:pabjobs/theme/text_theme.dart';

class EditEmployement extends StatefulWidget {
  const EditEmployement({Key? key}) : super(key: key);

  @override
  State<EditEmployement> createState() => _EditEmployementState();
}

class _EditEmployementState extends State<EditEmployement> {
  ...
  void initState() {
    ...
    _myDesignationSelection = employmentDetails[0];
    _myCategorySelection = employmentDetails[1];
    currentCompany = employmentDetails[2];

    if (currentCompany == "Yes") {
      _value = 1;
    } else if (currentCompany == "No") {
      _value = 2;
    }
    (employmentDetails[3] != null)
        ? _selectedDate = employmentDetails[3]
        : _selectedDate = DateTime.now();

    (employmentDetails[4] != null)
        ? _selectedDate1 = employmentDetails[4]
        : _selectedDate1 = DateTime.now();
    textController.text = employmentDetails[5];
  }
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      CustomSearchableDropDown(
                        ...
                        label: (_myDesignationSelection != null)
                      ...
                      CustomSearchableDropDown(
                        ...
                        label: (_myCategorySelection != null)
                            ? _myCategorySelection
                            : 'Present Organiztion Category',
                        labelStyle:
                            PABTextTheme.content.copyWith(color: Colors.black),
                        dropdownItemStyle:
                            PABTextTheme.content.copyWith(color: Colors.black),
                        ...
                        child: TextButton(
                            ...
                            onPressed: () async {
                              if (_myDesignationSelection != null &&
                                  ...
                                  currentCompany != null &&
                                  textController.text != "") {
                                final x = await APIService.editEmployement(
                                    employmentDetails[6],
                                    _myDesignationSelection!,
                                    _myCategorySelection!,
                                    currentCompany!,
