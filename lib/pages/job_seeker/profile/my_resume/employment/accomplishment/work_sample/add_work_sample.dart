...
class AddWorkSample extends StatefulWidget {
  AddWorkSample({Key? key}) : super(key: key);
  @override
  State<AddWorkSample> createState() => _WorkSampleState();
}

class _WorkSampleState extends State<AddWorkSample> {
  final workSampleDetails = Get.arguments;
                        ...
                        child: TextButton(
                            ...
                            onPressed: () async {
                              if (textController.text != "" &&
                                ...
                                final x =
                                    await APIService.acccomplishmentDetails(
                                        textController.text,
                                        text1Controller.text,
